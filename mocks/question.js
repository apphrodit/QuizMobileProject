const questions = [
    ...
    {
        pergunta: "Quem se chama Napoleão do Irã?",
        respostas : [
            {resp :"Ali Khamenei ", status: false},
            {resp :"Reza Khan", status: false},
            {resp :"Nader Shah", status: true},
        ]
    },
    {
    ...
    {
        pergunta: "Qual presidente dos EUA tinha uma casa chamada The Hermitage?",
        respostas : [
            {resp :"Barack Obama", status: false},
            {resp :"Donald Trump", status: false},
            {resp :"André Jackson", status: true},
        ]
    },
    {
    ...
    {
        pergunta: "Onde é realizada a primeira Olimpíada de Verão?",
        respostas : [
            {resp :"Rio de Janeiro, Brasil", status: false},
            {resp :"Pequim, China", status: false},
            {resp :"Atenas, Grécia", status: true},
        ]
    },
    {
